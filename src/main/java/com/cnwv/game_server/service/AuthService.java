...
public class AuthService {
    ...
    public String extractUsername(String token) {
        try { return jwtUtil.extractUsername(token); }
        catch (Exception e) { throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "유효하지 않은 토큰"); }
    }
    ...
    public LoginResponse refresh(String username, String refreshToken) {
        ...
        var res = new LoginResponse();
        res.setAccessToken(jwtUtil.generateAccessToken(username));
